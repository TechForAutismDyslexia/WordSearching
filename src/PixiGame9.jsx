...
function PixiGame9() {
    ...
    let completedWord = useMemo(()=>['jump','pull','less','sell','like','east','trek'], []);
    ...
    useEffect(() => {
        ...
        const textArr = ['j','o','d','s','e','l','l','x','z','k','u','s','f','s','o','f','i','o','q','e','m','h','m','e','k','u','k','w','u','r','p','u','l','l','j','s','e','a','s','t'];
        let k = 0;
        let hei;
        let newPuzzle = [];
...
if(window.innerHeight > 630 && window.innerWidth > 830){
    ...
    {/* {isCompleted && <ConfettiComponent isCompleted={{isCompleted}}/>} */}
      <div className="image-container">
        ...
        <a type="button" className="btn btn-secondary btn-lg" href='/game8'>Previous</a>
    ...
    return (
      ...
      <div className="image-container">
        ...
        <a type="button" className="btn btn-secondary" href='/game8'>Previous</a>
