...
function PixiGame7() {
    ...
    let completedWord = useMemo(()=>['went','tent','trip','pond','desk'], []);
    ...
    useEffect(() => {
        ...
        const textArr = ['a','c','b','t','e','k','r','i','s','p','a','o','l','u','a','k','d','f','n','c','e','s','r','u','i','c','o','w','x','u','s','r','g','e','q','j','f','n','x','r','c','b','r','n','o','e','q','l','w','u','r','k','b','r','t','k','k','z','y','o','d','l','a','n'];
        let k = 0;
        let hei;
        let newPuzzle = [];
...
if(window.innerHeight > 630 && window.innerWidth > 830){
    ...
    {/* {isCompleted && <ConfettiComponent isCompleted={{isCompleted}}/>} */}
      <div className="image-container">
        ...
        <a type="button" className="btn btn-secondary btn-lg" href='/game6'>Previous</a>
            <a type="button" className="btn btn-secondary btn-lg" href='/game8' style={{marginLeft: window.innerWidth/4}}>Next</a>
            </div>
            <br/>
            <br/>
            <br/>
    ...
    return (
      ...
      <div className="image-container">
        ...
        <a type="button" className="btn btn-secondary" href='/game6'>Previous</a>
            <a type="button" className="btn btn-secondary" href='/game8' style={{marginLeft: window.innerWidth/4}}>Next</a>
            </div>
